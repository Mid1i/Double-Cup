...
export function createLoginButton() {
    ...
    image_wrapper.classList.add("login__btn__icon", "js-login__btn");
    image_wrapper.appendChild(image);

    let text = document.createElement("p");
    text.classList.add("login__btn__text", "js-login__btn");
    text.innerHTML = "Вход";
...
export function createProfileButton(UserName) {
    ...
    let image_wrapper = document.createElement("div");
    image_wrapper.classList.add("login__btn__icon", "js-profile");
    image_wrapper.appendChild(image);

    let text = document.createElement("p");
    text.classList.add("login__btn__text", "js-profile");
